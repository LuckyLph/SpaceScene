...
function trianglePrism(side) 
{
   ...
   face( [-s,-s,-s, -s,s+s,-s, s+(s3),s+s,-s, s+(s3),-s,-s], [0,0,-1] );
   face( [-s,s+s,-s, -s,-s,s, s+(s3),-s,s, s+(s3),s+s,-s], [0,1,0] );
   face( [-s,-s,-s, s+(s3),-s,-s, s+(s3),-s,s, -s,-s,s], [0,-1,0] );
   face( [s+(s3),-s,-s, s+(s3),s+s,-s, s+(s3),s+s,-s, s+(s3),-s,s], [1,0,0] );
   face( [-s,-s,-s, -s,-s,s, -s,s+s,-s, -s,s+s,-s], [-1,0,0] );
   return {
      vertexPositions: new Float32Array(coords),
      vertexNormals: new Float32Array(normals),
      vertexTextureCoords: new Float32Array(texCoords),
